...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
		...
		BasicDBObject document = new BasicDBObject("_id", username).append(
    ...
    public DBObject validateLogin(String username, String password) {
		...
		BasicDBObject document = new BasicDBObject("_id", username);
        user = usersCollection.findOne(document);
